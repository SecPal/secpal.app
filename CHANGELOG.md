...
- raised overridden transitive `brace-expansion`, `esbuild`, and `vite` packages to patched releases so `npm audit` no longer reports the current website toolchain findings
